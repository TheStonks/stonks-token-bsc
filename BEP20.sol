...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Stonks";
    string internal constant SYMBOL = "STONK";
    ...
    uint256 internal constant TOTAL_SUPPLY = 100000000000000 * ZEROES;
...
abstract contract StonksToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract StonksV1 is StonksToken{

    constructor() StonksToken(Env.MainnetV2){
